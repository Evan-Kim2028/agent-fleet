...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a `composer-2.5` subagent with a specific scope; review the diff.
